...
Original file is located at
    https://colab.research.google.com/drive/1jMQeUDr9ZRjouLMkQhZQRVHmR0iLf7K-
"""
...
class Biblioteca:
    ...
    def grafoMalla(self, n, m, dirigido=False):
        ...
        #Realiso una secuencia de los nodos
        self.listaAristasL = []
        for i in self.listaAristas:
            for j in i:
                self.listaAristasL.append(j)
            
        return self.listaAristas, self.listaAristasL
    ...
    def grafoErdosRenyi(self, n, m, dirigido=False, auto=False):
        ...
        while s < m: #proporciono el la cantidad de aritrias que se puede generar 
            ...
            if u == v:
                ...
                nod= u,v
            if nod in aristarepe:
                s-=1
            else:
                aristarepe.append((nod))
            s+=1
...
class Main: 
    ...
    #se genera el radio
    r = 100
    #se inidica el numero de grados de un nodo
    d = m
    """b.grafoMalla(n, m) 
    print('Graficar la malla')
    print(b.listaAristas)
    l = b.listaAristasL
    for i in range(0,len(l)-1,2):
        g.agregarAristas(l[i],l[i+1])
    for v in g.vertices:
        print('Nodo', v, 'Vecinos', g.vertices[v].vecinos)"""

    """b.grafoErdosRenyi(n, m)
    ...
    """b.grafoGeografico(n, r, x, y) # es importante generar un cuadrado x y y confome al tamaño de n
    ...
    for i in range(0,len(l)-1,2):
        g.agregarAristas(l[i],l[i+1])
    for v in g.vertices:
        print('Nodo', v, '__ Vecinos', g.vertices[v].vecinos)